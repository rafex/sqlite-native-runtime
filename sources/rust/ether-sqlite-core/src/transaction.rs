...
pub unsafe fn snr_begin(handle: *mut Handle) -> i32 {
...
/// # Safety
/// `handle` debe ser un puntero válido.
pub unsafe fn snr_begin_immediate(handle: *mut Handle) -> i32 {
...
/// # Safety
/// `handle` debe ser un puntero válido.
pub unsafe fn snr_begin_exclusive(handle: *mut Handle) -> i32 {
...
/// # Safety
/// `handle` debe ser un puntero válido.
pub unsafe fn snr_commit(handle: *mut Handle) -> i32 {
...
/// # Safety
/// `handle` debe ser un puntero válido.
pub unsafe fn snr_rollback(handle: *mut Handle) -> i32 {
...
pub unsafe fn snr_savepoint(handle: *mut Handle, name: *const c_char) -> i32 {
...
/// # Safety
/// `handle` y `name` deben ser punteros válidos.
pub unsafe fn snr_release(handle: *mut Handle, name: *const c_char) -> i32 {
...
/// # Safety
/// `handle` y `name` deben ser punteros válidos.
pub unsafe fn snr_rollback_to(handle: *mut Handle, name: *const c_char) -> i32 {
