 ...
 * }</pre>
 */
public final class FfmSqliteStatement implements SqliteStatement {
    ...
    FfmSqliteStatement(MemorySegment stmt) {
        this.stmt = stmt;
        this.onClose = null;
    }

    FfmSqliteStatement(MemorySegment stmt, Runnable onClose) {
        this.stmt = stmt;
