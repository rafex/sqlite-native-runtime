 ...
 * }</pre>
 */
public final class FfmJava21SqliteConnection implements SqliteConnection {

    // WalMode y WalCheckpointResult están definidos en la interface SqliteConnection (ether-sqlite-core)

    private static final Logger LOG = Logger.getLogger(FfmJava21SqliteConnection.class.getName());

    private final MemorySegment handle;
    private final AtomicInteger openStatements = new AtomicInteger(0);
    private boolean closed = false;

    private FfmJava21SqliteConnection(MemorySegment handle) {
        this.handle = handle;
    }
    ...
    public SqliteStatement prepare(String sql) {
        ...
        return new FfmJava21SqliteStatement(stmtHandle, openStatements::decrementAndGet);
    }
    ...
    public static String sqliteVersion() {
        return FfmJava21SqliteStatement.readAndFreeString(SqliteLibrary.snr_sqlite_version());
    }
    ...
    public static String lastError() {
        return FfmJava21SqliteStatement.readAndFreeString(SqliteLibrary.snr_last_error_copy());
    }
