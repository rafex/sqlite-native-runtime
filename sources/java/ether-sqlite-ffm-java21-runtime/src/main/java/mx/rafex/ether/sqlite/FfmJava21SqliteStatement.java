 ...
 * }</pre>
 */
public final class FfmJava21SqliteStatement implements SqliteStatement {
    ...
    FfmJava21SqliteStatement(MemorySegment stmt) {
        this.stmt = stmt;
        this.onClose = null;
    }

    FfmJava21SqliteStatement(MemorySegment stmt, Runnable onClose) {
        this.stmt = stmt;
