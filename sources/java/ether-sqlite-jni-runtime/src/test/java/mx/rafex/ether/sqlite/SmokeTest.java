...
/**
 * Test de humo JNI — ejecutar con:
 *
 * <pre>
 *   ETHER_SQLITE_JNI_LIB=/path/to/libether_sqlite_jni_runtime.dylib \
...
public class SmokeTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("SQLite version: " + JniSqliteConnection.sqliteVersion());
