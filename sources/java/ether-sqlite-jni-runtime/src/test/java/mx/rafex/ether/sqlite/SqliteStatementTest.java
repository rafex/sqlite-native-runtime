...
/**
 * Tests unitarios para {@link SqliteStatement} via JNI.
 * Cubre binds, step, stepAndDone, reset, clearBindings,
 * columnXxx, columnName y parameterIndex.
 */
class SqliteStatementTest {
    ...
    void close_withOnCloseCallback() {
        ...
        // JniSqliteStatement con handle=0 — snr_stmt_close(NULL) es no-op en Rust
        boolean[] called = {false};
        var stmt = new JniSqliteStatement(0L, () -> called[0] = true);
        stmt.close();
    ...
    void close_withoutOnCloseCallback() {
        ...
        var stmt = new JniSqliteStatement(0L);
        assertDoesNotThrow(stmt::close);
    }
    ...
    void lastError_doesNotThrow() {
        ...
        assertDoesNotThrow(JniSqliteStatement::lastError);
    }
}
